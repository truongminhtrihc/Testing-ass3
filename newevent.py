...
class Module1TestUsecase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        accessToDashboard(self.driver)
        
        clickToNewevent(self.driver)
        
    def test_NE001001(self):
        print("---------------test_NE001001---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",0)
        print("---------------test_NE001001 End---------------")
    def test_NE001003(self):
        print("---------------test_NE001003---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",False)
        print("---------------test_NE001003 End---------------")
    def test_NE001004(self):
        print("---------------test_NE001004---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",1,"12","4","2024")
        print("---------------test_NE001004 End---------------")
    def test_NE001005(self):
        print("---------------test_NE001005---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",2,None,None,None,"45")
        print("---------------test_NE001005 End---------------")
    def test_NE001006(self):
        print("---------------test_NE001006---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",0,None,None,None,None,True,"2") 
        print("---------------test_NE001006 End---------------")
    def test_NE001007(self):
        print("---------------test_NE001007---------------")
        fillToForm(self.driver) 
        closeF(self.driver)
        print("---------------test_NE001007 End---------------")
        
    def test_NE001008(self):
        print("---------------test_NE001008---------------")
        fillToForm(self.driver,"kiem tra GK","31","2","2024",False)
        print("---------------test_NE001008 End---------------")
    def test_NE001009(self):
        print("---------------test_NE001009---------------")
        fillToForm(self.driver,"kiem tra GK","3","2","2024",True,None,None,1,"1","1","2024")
        closeF(self.driver)
        print("---------------test_NE001009 End---------------")
        
    def test_NE001010(self):
        print("---------------test_NE001010---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",2,None,None,None,"-1")
        closeF(self.driver)
        print("---------------test_NE001010 End---------------")
    def test_NE001011(self):
        print("---------------test_NE001011---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",2,None,None,None,"999999999")
        closeF(self.driver)
        print("---------------test_NE001011 End---------------")
        
    def test_NE001012(self):
        print("---------------test_NE001012---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",0,None,None,None,None,True,"-1") 
        closeF(self.driver)
        print("---------------test_NE001012 End---------------")
        
    def test_NE001013(self):
        print("---------------test_NE001013---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",0,None,None,None,None,True,"2.5") 
        closeF(self.driver)
        print("---------------test_NE001013 End---------------")
       
    def test_NE001014(self):
        print("---------------test_NE001014---------------")
        fillToForm(self.driver,"kiem tra GK","9","4","2024",True,"kiểm tra 45p","H6 112",0,None,None,None,None,True,"99999") 
        closeF(self.driver)
...
class Module2TestBoudary(unittest.TestCase):
    ...
    def test_NE003001(self):
        print("------------test_NE003001------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","4","2000")
        closeF(self.driver)
        print("------------test_NE003001 End------------")
    def test_NE003002(self):
        print("------------test_NE003002------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","4","2000")
        closeF(self.driver)
        print("------------test_NE003002 End------------")
    def test_NE003003(self):
        print("------------test_NE003003------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","4","2000")
        closeF(self.driver)
        print("------------test_NE003003 End------------")
    def test_NE003004(self):
        print("------------test_NE003004------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","4","2000")
        closeF(self.driver)
        print("------------test_NE003004 End------------")
    def test_NE003005(self):
        print("------------test_NE003005------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","4","1900")
        closeF(self.driver)
        print("------------test_NE003005 End------------")
    def test_NE003006(self):
        print("------------test_NE003006------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","4","2004")
        closeF(self.driver)
        print("------------test_NE003006 End------------")
    def test_NE003007(self):
        print("------------test_NE003007------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","4","1901")
        closeF(self.driver)
        print("------------test_NE003007 End------------")
    def test_NE003008(self):
        print("------------test_NE003008------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","4","1900")
        closeF(self.driver)
        print("------------test_NE003008 End------------")
    def test_NE003009(self):
        print("------------test_NE003009------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","4","2004")
        closeF(self.driver)
        print("------------test_NE003009 End------------")
    def test_NE003010(self):
        print("------------test_NE003010------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","4","1901")
        closeF(self.driver)
        print("------------test_NE003010 End------------")
    def test_NE003011(self):
        print("------------test_NE003011------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","4","1900")
        closeF(self.driver)
        print("------------test_NE003011 End------------")
    def test_NE003012(self):
        print("------------test_NE003012------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","4","2004")
        closeF(self.driver)
        print("------------test_NE003012 End------------")
    def test_NE003013(self):
        print("------------test_NE003013------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","4","1901")
        closeF(self.driver)
        print("------------test_NE003013 End------------")
    def test_NE003014(self):
        print("------------test_NE003014------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","4","1900")
        closeF(self.driver)
        print("------------test_NE003014 End------------")
    def test_NE003015(self):
        print("------------test_NE003015------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","4","2004")
        closeF(self.driver)
        print("------------test_NE003015 End------------")
    def test_NE003016(self):
        print("------------test_NE003016------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","4","1901")
        closeF(self.driver)
        print("------------test_NE003016 End------------")
    def test_NE003017(self):
        print("------------test_NE003017------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","1","2000")
        closeF(self.driver)
        print("------------test_NE003017 End------------")
    def test_NE003018(self):
        print("------------test_NE003018------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","1","2000")
        closeF(self.driver)
        print("------------test_NE003018 End------------")
    def test_NE003019(self):
        print("------------test_NE003019------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","1","2000")
        closeF(self.driver)
        print("------------test_NE003019 End------------")
    def test_NE003020(self):
        print("------------test_NE003020------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","1","2000")
        closeF(self.driver)
        print("------------test_NE003020 End------------")
    def test_NE003021(self):
        print("------------test_NE003021------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","1","1900")
        closeF(self.driver)
        print("------------test_NE003021 End------------")
    def test_NE003022(self):
        print("------------test_NE003022------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","1","2004")
        closeF(self.driver)
        print("------------test_NE003022 End------------")
    def test_NE003023(self):
        print("------------test_NE003023------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","1","1901")
        closeF(self.driver)
        print("------------test_NE003023 End------------")
    def test_NE003024(self):
        print("------------test_NE003024------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","1","1900")
        closeF(self.driver)
        print("------------test_NE003024 End------------")
    def test_NE003025(self):
        print("------------test_NE003025------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","1","2004")
        closeF(self.driver)
        print("------------test_NE003025 End------------")
    def test_NE003026(self):
        print("------------test_NE003026------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","1","1901")
        closeF(self.driver)
        print("------------test_NE003026 End------------")
    def test_NE003027(self):
        print("------------test_NE003027------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","1","1900")
        closeF(self.driver)
        print("------------test_NE003027 End------------")
    def test_NE003028(self):
        print("------------test_NE003028------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","1","2004")
        closeF(self.driver)
        print("------------test_NE003028 End------------")
    def test_NE003029(self):
        print("------------test_NE003029------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","1","1901")
        closeF(self.driver)
        print("------------test_NE003029 End------------")
    def test_NE003033(self):
        print("------------test_NE003033------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","2","2000")
        closeF(self.driver)
        print("------------test_NE003033 End------------")
    def test_NE003034(self):
        print("------------test_NE003034------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","2","2000")
        closeF(self.driver)
        print("------------test_NE003034 End------------")
    def test_NE003035(self):
        print("------------test_NE003035------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","2","2000")
        closeF(self.driver)
        print("------------test_NE003035 End------------")
    def test_NE003036(self):
        print("------------test_NE003036------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","2","2000")
        closeF(self.driver)
        print("------------test_NE003036 End------------")
    def test_NE003037(self):
        print("------------test_NE003037------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","2","1900")
        closeF(self.driver)
        print("------------test_NE003037 End------------")
    def test_NE003038(self):
        print("------------test_NE003038------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","2","2004")
        closeF(self.driver)
        print("------------test_NE003038 End------------")
    def test_NE003039(self):
        print("------------test_NE003039------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"15","2","1901")
        closeF(self.driver)
        print("------------test_NE003039 End------------")
    def test_NE003040(self):
        print("------------test_NE003040------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","2","1900")
        closeF(self.driver)
        print("------------test_NE003040 End------------")
    def test_NE003041(self):
        print("------------test_NE003041------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","2","2004")
        closeF(self.driver)
        print("------------test_NE003041 End------------")
    def test_NE003042(self):
        print("------------test_NE003042------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"29","2","1901")
        closeF(self.driver)
        print("------------test_NE003042 End------------")
    def test_NE003043(self):
        print("------------test_NE003043------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","2","1900")
        closeF(self.driver)
        print("------------test_NE003043 End------------")
    def test_NE003044(self):
        print("------------test_NE003044------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","2","2004")
        closeF(self.driver)
        print("------------test_NE003044 End------------")
    def test_NE003045(self):
        print("------------test_NE003045------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"30","2","1901")
        closeF(self.driver)
        print("------------test_NE003045 End------------")
    def test_NE003046(self):
        print("------------test_NE003046------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","2","1900")
        closeF(self.driver)
        print("------------test_NE003046 End------------")
    def test_NE003047(self):
        print("------------test_NE003047------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","2","2004")
        closeF(self.driver)
        print("------------test_NE003047 End------------")
    def test_NE003048(self):
        print("------------test_NE003048------------")
        fillToForm(self.driver,"kiem tra GK","1","4","2024",True,None,None,1,"31","2","1901")
        closeF(self.driver)
...
def accessToDashboard(driver):
    try: 
        dashboard_link = WebDriverWait(driver, 20,2).until(EC.element_to_be_clickable((By.CSS_SELECTOR, "a[href='https://sandbox403.moodledemo.net/my/']")))
...
def clickToNewevent(driver):
    try: 
        ...
        print("Vui lòng thực hiện lại chức năng vì thời gian load phần tử quá lâu.")
def selectdate(driver,day, month, year):
    try:
        # year
        ...
        print("Vui lòng thực hiện lại chức năng vì thời gian load phần tử quá lâu.")
def selectdateUntil(driver,day, month, year):
    try:
        # year
...
def fillToForm(driver,title=None,day=None, month=None,year=None,isShowmore=False,description=None,location=None, duration=None,dayU=None, monthU=None,yearU=None,durationMinute=None,isRepeat=False,repeatS=None):
    try:
        # title
        ...
        if isShowmore is True: 
            ...
            time.sleep(2)
            if duration == 1:
                selectdateUntil(driver,dayU,monthU,yearU)
            if duration == 2:
